...
class ManagerPayrollReportPage extends StatefulWidget {
  final String employeeId;
  final String employeeName;

  const ManagerPayrollReportPage({
    super.key,
  ...
  @override
  State<ManagerPayrollReportPage> createState() => _ManagerPayrollReportPageState();
}

class _ManagerPayrollReportPageState extends State<ManagerPayrollReportPage> {
      ...
      body: _isLoading
          ...
          : Column(
              children: [
                ...
                // Daily Total Card - Sum of all daily_salary in period
                Container(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${_attendanceData.where((d) => ((d['daily_salary'] as num?)?.toDouble() ?? 0) > 0).length} يوم عمل',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 11,
                            ),
