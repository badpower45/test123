...
class _ManagerAddEmployeePageState extends State<ManagerAddEmployeePage> {
  ...
  Future<void> _addEmployee() async {
    ...
    try {
      ...
      String? branchId;
      try {
        final branchData = await SupabaseBranchService.getBranchByName(
          widget.managerBranch,
        );
        branchId = branchData?['id'] as String?;
        print(
          '🔍 [Manager Add Employee] Branch: ${widget.managerBranch}, Branch ID: $branchId',
        );
      } catch (e) {
      ...
      final employeeData = <String, dynamic>{
        ...
        'leave_allowance':
            double.tryParse(_leaveAllowanceController.text) ?? 100,
        'is_active': true,
      };
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
                      return 'الرجاء إدخال بدل الإجازة';
                    }
                    final allowance = double.tryParse(value);
                    if (allowance == null || allowance < 0) {
                      return 'الرجاء إدخال بدل إجازة صحيح';
                    }
                    return null;
                  },
                ),
